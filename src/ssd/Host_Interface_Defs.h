...
#define NVME_BWRITE_OPCODE 0x0003
#define NVME_BREAD_OPCODE 0x0004
#define NVME_COMPUTE_OPCODE 0x0005
#define NVME_LOWERTX_OPCODE 0x0006
#define NVME_UPPERTX_OPCODE 0x0007
...
{
	uint8_t Opcode;//Is it a read or write request [ZMAC] - or it can be a ISP command
	uint8_t PRP_FUSE;
