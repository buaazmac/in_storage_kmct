...
namespace SSD_Components
{
	...
	public:
		...
		static unsigned long IssuedIspCMD, IssuedReadCMD, IssuedCopybackReadCMD, IssuedInterleaveReadCMD, IssuedMultiplaneReadCMD, IssuedMultiplaneCopybackReadCMD;
		...
		static unsigned long IssuedSuspendProgramCMD, IssuedSuspendEraseCMD, IssuedSuspendIspCMD;
